<template>
  <el-card class="post-preview" shadow="hover" @click="goToDetail">
    <!-- 作者信息区域 -->
...
import { ChatDotRound, Star, Share, More } from '@element-plus/icons-vue';
...
const isAuthor = computed(() => {
  return userStore.userInfo?.id === String(props.post.author.id);
});
