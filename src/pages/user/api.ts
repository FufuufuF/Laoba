  ...
  '101': [
    {
      ...
      author: { id: 101, name: '小明同学', avatar: 'https://cube.elemecdn.com/0/88/03b0d39583f48206768a7534e55bcpng.png' },
  ...
  '102': [
    {
      ...
      author: { id: 102, name: '吃货小红', avatar: 'https://cube.elemecdn.com/3/7c/3ea6beec64369c2642b92c6726f1epng.png' },
  ...
  '103': [
    {
      ...
      author: { id: 103, name: '运动健将', avatar: 'https://cube.elemecdn.com/9/c2/f0ee8a3c7c9638a54940382568c9dpng.png' },
  ...
  '104': [
    {
      ...
      author: { id: 104, name: '学霸小李', avatar: 'https://cube.elemecdn.com/c/5e/5e5e5e5e5e5e5e5e5e5e5e5e5e5epng.png' },
  ...
  '105': [
    {
      ...
      author: { id: 105, name: '骑行爱好者', avatar: 'https://cube.elemecdn.com/e/fd/0fc7d20532fdaf769a25683617711png.png' },
  ...
  '106': [
    {
      ...
      author: { id: 106, name: '代码小王', avatar: 'https://cube.elemecdn.com/a/3f/3990ef257c6c86e142d721f16e10png.png' },
  ...
  '107': [
    {
      ...
      author: { id: 107, name: '摄影社长', avatar: 'https://cube.elemecdn.com/b/a4/3c999e8b0a5e7b8b8b8b8b8b8b8png.png' },
 ...
 * 获取用户发布的帖子列表
 */
export const getUserPosts = async (userId: string, page = 1, pageSize = 20): Promise<ApiResponse<{
  list: Post[];
  total: number;
}>> => {
  if (USE_MOCK) {
  ...
  return apiClient.get(`/users/${userId}/posts?page=${page}&pageSize=${pageSize}`);
};
